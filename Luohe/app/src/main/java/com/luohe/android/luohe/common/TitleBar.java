...
public class TitleBar extends ViewGroup implements View.OnClickListener {
    ...
    public void setCustomTitle(View titleView, ViewGroup.LayoutParams layoutParams) {
        mCenterText.setVisibility(View.GONE);
        mRightLayout.setVisibility(GONE);
        mLeftText.setVisibility(GONE);
        mCenterLayout.addView(titleView, layoutParams);
        mCenterLayout.setPadding(dip2px(8), dip2px(8), dip2px(8), dip2px(8));
    }
    ...
    public View addAction(Action action, int index) {
        ...
        if (action instanceof TextAction) {//add by gq,just to adapter right btn
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (mLeftText.getVisibility() == GONE && mRightLayout.getVisibility() == GONE) {
            mCenterLayout.measure(
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        if (mLeftText.getVisibility() == GONE && mRightLayout.getVisibility() == GONE) {
            mCenterLayout.layout(0, mStatusBarHeight,
                    mScreenWidth, getMeasuredHeight());
        }
    ...
    public void setDefauleBackBtn() {
        this.setLeftImageResource(R.drawable.back_btn);
    }
