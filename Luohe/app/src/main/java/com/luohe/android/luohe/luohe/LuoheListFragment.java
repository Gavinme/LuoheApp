 ...
 */
public class LuoheListFragment extends BaseRefreshListFragment<LuoheListFragment.luoheBean> {
    ...
    protected void onListItemClick(View view, int adapterPosition) {
       ...
       //// TODO: 16/3/29
        startActivity(new Intent(getActivity(),LuoheDetailActivity.class));
    }
