 ...
 */
public class HisThemeListFragment extends BaseRefreshListFragment<LuoheWrapBean.SubjectBean> {
	private int userId;
	@Override
	...
	protected void onPullDown(final AdapterManger<LuoheWrapBean.SubjectBean> mAdapterManger) {
		ApiLoader.getApiService().hisSubject(userId,0).subscribeOn(Schedulers.io()).observeOn(AndroidSchedulers.mainThread())
