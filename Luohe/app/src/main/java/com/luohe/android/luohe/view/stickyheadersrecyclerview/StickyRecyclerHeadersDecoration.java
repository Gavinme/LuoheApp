...
public class StickyRecyclerHeadersDecoration extends RecyclerView.ItemDecoration {
    ...
    public void onDrawOver(Canvas canvas, RecyclerView parent, RecyclerView.State state) {
        ...
        if (parent.getChildCount() > 0 && mAdapter.getItemCount() > 0) {
            ...
            if (needSticky() && mAdapter.getHeaderId(firstPosition) >= 0) {
            ...
            for (int i = needSticky() ? 1 : 0; i < parent.getChildCount(); i++) {
...
//            return false;
            ...
            return position > 0 && position < mAdapter.getItemCount() && mAdapter.getHeaderId(position) != mAdapter.getHeaderId(position - 1);
    }
