...
package com.luohe.android.luohe.view.swipeback;
        ...
        switch (action) {
            ...
            case MotionEventCompat.ACTION_POINTER_UP: {
                ...
                if (mDragState == STATE_DRAGGING && pointerId == mActivePointerId) {
                    // Try to com.luohe.android.luohe.find another pointer that's still holding on to
                    // the captured view.
                    ...
                    if (newActivePointer == INVALID_POINTER) {
                        // We didn't com.luohe.android.luohe.find another pointer still touching the
                        // view, release it.
