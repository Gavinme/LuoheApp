...
public class UIImageView extends ImageView {
	...
	private void init(final Context context, final AttributeSet attrs) {
		...
		mPressedColor = typedArray.getColor(R.styleable.UIImageView_color_pressed,
		...
		mRadius = typedArray.getDimensionPixelSize(R.styleable.UIImageView_radius,
				LayoutUtil.GetPixelByDIP(getContext(), 2));
		typedArray.recycle();
		mPaint = new Paint();
