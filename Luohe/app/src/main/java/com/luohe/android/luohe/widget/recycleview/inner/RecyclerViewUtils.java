package com.luohe.android.luohe.widget.recycleview.inner;
...
public class RecyclerViewUtils {
     ...
     * @return
     */
    public static int getAdapterPosition(RecyclerView recyclerView, int position) {
        RecyclerView.Adapter outerAdapter = recyclerView.getAdapter();
        if (outerAdapter != null && outerAdapter instanceof HeaderAndFooterRecyclerViewAdapter) {

            int headerViewCounter = ((HeaderAndFooterRecyclerViewAdapter) outerAdapter).getHeaderViewsCount();
            if (headerViewCounter > 0) {
                return position - headerViewCounter;
            }
        }
        return position;
    }
